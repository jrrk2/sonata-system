...
rm -rf build/lowrisc_sonata_system_0/synth-vivado build/lowrisc_sonata_system_0/src/lowrisc_sonata_system_0
fusesoc --cores-root=. run --target=synth --setup --build lowrisc:sonata:system --SRAMInitFile=/home/jonathan/vivado-risc-v/sonata_boot/boot.vmem
...
echo rsync sonata-vX.Y.bit.slot?.uf2 192.168.1.169:Downloads
