...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_27_ds_h2d [25];
  tl_d2h_t tl_s1n_27_ds_d2h [25];
  ...
  tl_h2d_t tl_s1n_32_ds_h2d [3];
  tl_d2h_t tl_s1n_32_ds_d2h [3];

  // Create steering signal
  logic [1:0] dev_sel_s1n_32;
  ...
  assign tl_rev_tag_o = tl_s1n_27_ds_h2d[2];
  assign tl_s1n_27_ds_d2h[2] = tl_rev_tag_i;

  assign tl_dbg_dev_o = tl_s1n_27_ds_h2d[3];
  assign tl_s1n_27_ds_d2h[3] = tl_dbg_dev_i;

  assign tl_gpio_o = tl_s1n_27_ds_h2d[4];
  assign tl_s1n_27_ds_d2h[4] = tl_gpio_i;

  assign tl_pinmux_o = tl_s1n_27_ds_h2d[5];
  assign tl_s1n_27_ds_d2h[5] = tl_pinmux_i;

  assign tl_sm1_30_us_h2d[0] = tl_s1n_27_ds_h2d[6];
  assign tl_s1n_27_ds_d2h[6] = tl_sm1_30_us_d2h[0];
  ...
  assign tl_spi_lcd_o = tl_s1n_27_ds_h2d[11];
  assign tl_s1n_27_ds_d2h[11] = tl_spi_lcd_i;

  assign tl_spi_ethmac_o = tl_s1n_27_ds_h2d[12];
  assign tl_s1n_27_ds_d2h[12] = tl_spi_ethmac_i;

  assign tl_pwm0_o = tl_s1n_27_ds_h2d[13];
  assign tl_s1n_27_ds_d2h[13] = tl_pwm0_i;

  assign tl_uart0_o = tl_s1n_27_ds_h2d[14];
  assign tl_s1n_27_ds_d2h[14] = tl_uart0_i;

  assign tl_uart1_o = tl_s1n_27_ds_h2d[15];
  assign tl_s1n_27_ds_d2h[15] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_27_ds_h2d[16];
  assign tl_s1n_27_ds_d2h[16] = tl_uart2_i;

  assign tl_i2c0_o = tl_s1n_27_ds_h2d[17];
  assign tl_s1n_27_ds_d2h[17] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_27_ds_h2d[18];
  assign tl_s1n_27_ds_d2h[18] = tl_i2c1_i;

  assign tl_spi0_o = tl_s1n_27_ds_h2d[19];
  assign tl_s1n_27_ds_d2h[19] = tl_spi0_i;

  assign tl_spi1_o = tl_s1n_27_ds_h2d[20];
  assign tl_s1n_27_ds_d2h[20] = tl_spi1_i;

  assign tl_spi2_o = tl_s1n_27_ds_h2d[21];
  assign tl_s1n_27_ds_d2h[21] = tl_spi2_i;

  assign tl_flash_xip_reg_o = tl_s1n_27_ds_h2d[22];
  assign tl_s1n_27_ds_d2h[22] = tl_flash_xip_reg_i;

  assign tl_asf_31_us_h2d = tl_s1n_27_ds_h2d[23];
  assign tl_s1n_27_ds_d2h[23] = tl_asf_31_us_d2h;

  assign tl_rv_plic_o = tl_s1n_27_ds_h2d[24];
  assign tl_s1n_27_ds_d2h[24] = tl_rv_plic_i;

  assign tl_sm1_28_us_h2d[1] = tl_s1n_32_ds_h2d[0];
  assign tl_s1n_32_ds_d2h[0] = tl_sm1_28_us_d2h[1];

  assign tl_sm1_29_us_h2d[1] = tl_s1n_32_ds_h2d[1];
  assign tl_s1n_32_ds_d2h[1] = tl_sm1_29_us_d2h[1];

  assign tl_sm1_30_us_h2d[1] = tl_s1n_32_ds_h2d[2];
  assign tl_s1n_32_ds_d2h[2] = tl_sm1_30_us_d2h[1];

  assign tl_s1n_27_us_h2d = tl_ibex_lsu_i;
  assign tl_ibex_lsu_o = tl_s1n_27_us_d2h;

  assign tl_sram_o = tl_sm1_28_ds_h2d;
  assign tl_sm1_28_ds_d2h = tl_sram_i;

  assign tl_hyperram_o = tl_sm1_29_ds_h2d;
  assign tl_sm1_29_ds_d2h = tl_hyperram_i;

  assign tl_system_info_o = tl_sm1_30_ds_h2d;
  assign tl_sm1_30_ds_d2h = tl_system_info_i;

  assign tl_usbdev_o = tl_asf_31_ds_h2d;
  assign tl_asf_31_ds_d2h = tl_usbdev_i;

  assign tl_s1n_32_us_h2d = tl_dbg_host_i;
  assign tl_dbg_host_o = tl_s1n_32_us_d2h;
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (25'hf81d47),
    .DRspPass  (25'hf81d47),
    .DReqDepth (100'h1000001111110001010111000),
    .DRspDepth (100'h1000001111110001010111000),
    .N         (25)
  ) u_s1n_27 (
    .clk_i        (clk_sys_i),
    .rst_ni       (rst_sys_ni),
